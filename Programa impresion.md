...
| 2 | `resources/views/design/format.blade.php`, `edit_format.blade.php` (textos ticket → participación) |
| 3 | `resources/views/design/format.blade.php` (y opc. `edit_format`) – CSS y selección |
| 4 | `resources/views/design/format.blade.php`, `edit_format.blade.php` – keydown Delete/Backspace |
| 5 | `resources/views/design/format.blade.php`, `edit_format.blade.php` – clase/atributo crítico + JS |
| 6 | `resources/views/design/format.blade.php`, `edit_format.blade.php` – controles zoom |
| 7 | `resources/views/design/format.blade.php`, `edit_format.blade.php` – spinner/overlay en fetch/ajax |
