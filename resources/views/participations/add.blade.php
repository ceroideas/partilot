                ...
                <div class="card-body">
                    ...
                    <div class="{{isset($_GET['table']) ? '' : 'd-none'}}">
                        <h4 class="header-title">
                            ...
                            <a href="{{url('participations/add')}}" style="border-radius: 30px; width: 150px;" class="btn btn-md btn-dark float-end"><i style="position: relative; top: 2px;" class="ri-add-line"></i> Añadir</a>
                    ...
                    <div class="{{isset($_GET['table']) ? 'd-none' : ''}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-end">
                                <a href="{{url('participations/information')}}" style="border-radius: 30px; width: 200px; background-color: #e78307; color: #333; padding: 8px; font-weight: bolder; position: relative;" class="btn btn-md btn-light mt-2">Siguiente
