                ...
                <div class="card-body">
                    ...
                    <div class="row">
                    	...
                    	<div class="col-md-3" style="position: relative;">
                    		...
                    		<a href="{{url('social')}}" style="border-radius: 30px; width: 200px; background-color: #333; color: #fff; padding: 8px; font-weight: bolder; position: absolute; bottom: 16px;" class="btn btn-md btn-light mt-2">
                    						<i style="top: 6px; left: 32%; font-size: 18px; position: absolute;" class="ri-arrow-left-circle-line"></i> <span style="display: block; margin-left: 16px;">Atrás</span></a>
                    	</div>
                    	<div class="col-md-9">
                    		<div class="form-card bs" style="min-height: 658px;">
                    			<form action="{{url('social/add/design')}}" method="POST">
                    				@csrf
                    			<h4 class="mb-0 mt-1">
                    				Entidad en la que crear la Web Social
                    			</h4>
