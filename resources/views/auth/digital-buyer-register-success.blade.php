...
<head>
    <meta charset="utf-8" />
    <title>Registro completado | PARTILOT</title>
...
<div class="container py-5 text-center" style="max-width: 520px;">
    ...
    <h4>¡Cuenta creada!</h4>
    <p class="text-muted">Tus participaciones digitales ya están asociadas a tu cuenta. Descarga la app Partilot e inicia sesión con <strong>{{ $user->email }}</strong>.</p>
</div>
</body>
</html>
