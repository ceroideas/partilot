                ...
                <div class="card-body">
                    ...
                    <div class="row">
                    	...
                    	<div class="col-md-3" style="position: relative;">
                    		...
                    		<a href="{{route('groups.create')}}" style="border-radius: 30px; width: 200px; background-color: #333; color: #fff; padding: 8px; font-weight: bolder; position: absolute; bottom: 16px;" class="btn btn-md btn-light mt-2">
                    						<i style="top: 6px; left: 32%; font-size: 18px; position: absolute;" class="ri-arrow-left-circle-line"></i> <span style="display: block; margin-left: 16px;">Atrás</span></a>
                    	</div>
                    	
                    	<div class="col-md-6">
                    		<div class="form-card bs mb-3">
                    			<form id="group-form" action="{{ route('groups.store') }}" method="POST">
                    				@csrf
                    				<input type="hidden" name="entity_id" value="{{ $entity->id }}">
                    				<!-- Campos ocultos para enviar los vendedores seleccionados como array -->
                    				<div id="seller_ids_container"></div>
                    					...
                    					<div class="col-12">
                    						<div class="form-group mt-2 mb-3">
                    							...
                    							<div class="input-group input-group-merge group-form">
                    								...
                    								<input class="form-control" type="text" name="name" placeholder="Nombre del Grupo" style="border-radius: 0 30px 30px 0;" value="{{ old('name') }}" required>
                    							</div>
                    							@error('name')
                    	...
                    	<div class="col-md-3">
                    		<div class="form-card bs" style="height: 100%;">
                    			...
                    			<div class="d-none" id="added-sellers">
                    				<div class="form-group mt-2 mb-3">
                    ...
                    <div class="row">
                    	<div class="col-12 text-end">
                    		<button type="submit" form="group-form" style="border-radius: 30px; width: 200px; background-color: #e78307; color: #333; padding: 8px; font-weight: bolder; position: relative;" class="btn btn-md btn-light mt-2">Guardar
...
<script>
    ...
    $(document).on('click', '.add-seller', function(e) {
        ...
        let seller = { id: sellerId, name: sellerName, email: sellerEmail };
        ...
        $(this).closest('tr').find('.add-seller').hide();
