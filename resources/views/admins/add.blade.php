                    		...
                    		<div class="form-card bs" style="min-height: 658px;">
                    					...
                    					<div class="col-4">
                    						<div class="form-group mt-2 mb-3">
				                    			...
				                    			<div class="input-group input-group-merge group-form">
				                                    ...
				                                    <input class="form-control" type="text" placeholder="Nombre Administración" style="border-radius: 0 30px 30px 0;">
				                                </div>
			                    			</div>
                    					</div>
                    					<div class="col-3">
                    						<div class="form-group mt-2 mb-3">
				                    			...
				                    			<div class="input-group input-group-merge group-form">
				                                    ...
				                                    <input class="form-control" type="number" placeholder="000000" style="border-radius: 0 30px 30px 0;">
				                                </div>
			                    			</div>
                    					</div>
                    					<div class="col-5">
                    						<div class="form-group mt-2 mb-3">
				                    			...
				                    			<div class="input-group input-group-merge group-form">
				                                    ...
				                                    <input class="form-control" type="text" placeholder="José Andrés / Administración S.L.U." style="border-radius: 0 30px 30px 0;">
				                                </div>
			                    			</div>
                    					</div>
                    			...
                    			<div class="row">
                    				...
                    				<div class="col-4 text-end">
                    					<a href="{{url('administrations/add/manager')}}" style="border-radius: 30px; width: 200px; background-color: #e78307; color: #333; padding: 8px; font-weight: bolder; position: relative;" class="btn btn-md btn-light mt-2">Siguiente
