                    			...
                    			<div class="tab-content p-0">
			                    	...
			                    	<div class="tab-pane fade" id="datos_contacto">
                    					<div class="form-card bs" style="min-height: 658px;">
			                    			...
			                    			<small><i>@if($entity->manager)Todos los campos son obligatorios@else Esta entidad no tiene gestor asignado. Puedes agregar uno haciendo clic en "Agregar Gestor".@endif</i></small>
			                    			<div style="clear: both;"></div>
